...
static const float  SHADOW_WEIGHT_BORDER   		= 0.9f;
...
static const float GB_CAM_MAX = 130.0f;
...
static const float GB_STRENGTH_CH1 = 0.91; // Opacity of bottom layer 
...
static const float BORDER_MAP_TILE = 1000.0f;
